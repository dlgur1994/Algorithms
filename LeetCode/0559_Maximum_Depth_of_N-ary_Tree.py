...
# four.addChildren(eight)
# five.addChildren(nine)
# five.addChildren(ten)
# seven.addChildren(elev)
# eight.addChildren(twelv)
# nine.addChildren(thirt)
# elev.addChildren(fourt)
